...
"show_iets_ldos": "Compute the real-space inelastic tunneling spectroscopy (IETS) signal at a single energy, showing which sites carry the spin-flip response of the converged magnetic state. Requires a mean-field Hamiltonian solved via SCF with an onsite interaction.",
