...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pwave = QtWidgets.QLineEdit(self.tab_3)
        self.pwave.setObjectName("pwave")
        self.gridLayout.addWidget(self.pwave, 12, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.show_dosbands, 5, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.swave.setToolTip(_translate("MainWindow", "spin-singlet s-wave superconducting order"))
        self.swave.setText(_translate("MainWindow", "0.0"))
        self.exchange.setToolTip(_translate("MainWindow", "Exchange field in the system, taken as a vector with component Jx, Jy and Jz"))
        self.exchange.setText(_translate("MainWindow", "0.0, 0.0, 0.0"))
        ...
        self.label_26.setText(_translate("MainWindow", "s-wave superconductivity"))
        ...
        self.label_11.setText(_translate("MainWindow", "Kane-Mele SOC"))
        self.label_3.setText(_translate("MainWindow", "Exchange field"))
        ...
        self.label_39.setText(_translate("MainWindow", "p-wave superconductivity"))
        ...
        self.pwave.setToolTip(_translate("MainWindow", "d-vector of the spin triplet order p-wave order. The momentum dependence is taken of the form px + i py"))
        self.pwave.setText(_translate("MainWindow", "0.0, 0.0, 0.0"))
