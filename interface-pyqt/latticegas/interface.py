...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_filling = BodyLabel(self.tab_geometry)
        self.label_filling.setObjectName(u"label_filling")

        self.gridLayout_geometry_fields.addWidget(self.label_filling, 2, 0, 1, 1)

        self.filling = LineEdit(self.tab_geometry)
        self.filling.setObjectName(u"filling")

        self.gridLayout_geometry_fields.addWidget(self.filling, 2, 1, 1, 1)
        ...
        self.label_Jij = BodyLabel(self.tab_interactions)
        self.label_Jij.setObjectName(u"label_Jij")

        self.gridLayout_interactions_fields.addWidget(self.label_Jij, 0, 0, 1, 1)

        self.Jij = LineEdit(self.tab_interactions)
        self.Jij.setObjectName(u"Jij")

        self.gridLayout_interactions_fields.addWidget(self.Jij, 0, 1, 1, 1)

        self.label_mu_profile = BodyLabel(self.tab_interactions)
        self.label_mu_profile.setObjectName(u"label_mu_profile")

        self.gridLayout_interactions_fields.addWidget(self.label_mu_profile, 1, 0, 1, 1)

        self.mu_profile = LineEdit(self.tab_interactions)
        self.mu_profile.setObjectName(u"mu_profile")

        self.gridLayout_interactions_fields.addWidget(self.mu_profile, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Lattice gas", None))
        ...
        self.label_filling.setText(QCoreApplication.translate("MainWindow", u"Filling", None))
        self.filling.setText(QCoreApplication.translate("MainWindow", u"0.5", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_geometry), QCoreApplication.translate("MainWindow", u"Geometry", None))
        self.label_Jij.setText(QCoreApplication.translate("MainWindow", u"Neighbor couplings (J1, J2, J3)", None))
        self.Jij.setText(QCoreApplication.translate("MainWindow", u"1.0, 0.0, 0.0", None))
        self.label_mu_profile.setText(QCoreApplication.translate("MainWindow", u"Chemical potential profile", None))
        self.mu_profile.setText(QCoreApplication.translate("MainWindow", u"0.0", None))
