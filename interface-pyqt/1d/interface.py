...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hopping_image.setMinimumSize(QtCore.QSize(20, 0))
        ...
        self.label_dos_mode = QtWidgets.QLabel(self.tab_6)
        ...
        self.magnetization_plot_mode = QtWidgets.QComboBox(self.tab_8)
        ...
        self.gridLayout_24 = QtWidgets.QGridLayout(self.tab_14)
        ...
        self.sdos_ewindow = QtWidgets.QLineEdit(self.tab_14)
        self.sdos_ewindow.setObjectName("sdos_ewindow")
        self.gridLayout_15.addWidget(self.sdos_ewindow, 0, 1, 1, 1)
        self.sdos_delta = QtWidgets.QLineEdit(self.tab_14)
        self.sdos_delta.setObjectName("sdos_delta")
        self.gridLayout_15.addWidget(self.sdos_delta, 1, 1, 1, 1)
        self.show_edge_dos = QtWidgets.QPushButton(self.tab_14)
        self.show_edge_dos.setObjectName("show_edge_dos")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_48.setText(_translate("MainWindow", "Operator"))
        ...
        self.label_49.setText(_translate("MainWindow", "Plotting mode"))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_8), _translate("MainWindow", "Magnetism"))
        self.label_47.setText(_translate("MainWindow", "Smearing"))
        self.label_5.setText(_translate("MainWindow", "Energy window"))
        self.sdos_ewindow.setText(_translate("MainWindow", "1.0"))
        self.sdos_delta.setText(_translate("MainWindow", "0.01"))
        self.show_edge_dos.setText(_translate("MainWindow", "Compute edge DOS"))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_14), _translate("MainWindow", "Edeg DOS"))
