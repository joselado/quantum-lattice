...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_pwave, 13, 0, 1, 1)

        self.label_antikanemele = BodyLabel(self.tab_3)
        self.label_antikanemele.setObjectName(u"label_antikanemele")

        self.gridLayout.addWidget(self.label_antikanemele, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_hopping, 0, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.label_nk_kbands, 6, 0, 1, 1)

        self.nk_kbands = LineEdit(self.tab_9)
        self.nk_kbands.setObjectName(u"nk_kbands")

        self.gridLayout_11.addWidget(self.nk_kbands, 6, 1, 1, 1)
