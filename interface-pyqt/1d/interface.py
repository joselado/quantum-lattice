...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_21 = BodyLabel(self.tab_3)
        ...
        self.gridLayout.addWidget(self.pwave, 13, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.antikanemele, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.haldane, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.fermi, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.hoppings, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.antihaldane, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.mAF, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.swave, 12, 2, 1, 1)

        self.mAB = LineEdit(self.tab_3)
        self.mAB.setObjectName(u"mAB")

        self.gridLayout.addWidget(self.mAB, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.hopping_image, 0, 1, 1, 1)
        ...
        self.gridLayout_20 = QGridLayout(self.tab_2)
        ...
        self.label_48 = BodyLabel(self.tab_9)
        self.label_48.setObjectName(u"label_48")

        self.gridLayout_11.addWidget(self.label_48, 5, 0, 1, 1)
        ...
        self.gridLayout_14 = QGridLayout(self.tab_6)
        ...
        self.label_40 = BodyLabel(self.tab_6)
        ...
        self.label_41 = BodyLabel(self.tab_6)
        ...
        self.label_36 = BodyLabel(self.tab_7)
        self.label_36.setObjectName(u"label_36")

        self.gridLayout_22.addWidget(self.label_36, 3, 0, 1, 1)

        self.label_42 = BodyLabel(self.tab_7)
        ...
        self.label_43 = BodyLabel(self.tab_7)
        self.label_43.setObjectName(u"label_43")

        self.gridLayout_22.addWidget(self.label_43, 1, 0, 1, 1)

        self.label_44 = BodyLabel(self.tab_7)
        ...
        self.gridLayout_13 = QGridLayout(self.tab_13)
        self.gridLayout_13.setObjectName(u"gridLayout_13")
        self.gridLayout_23 = QGridLayout()
        self.gridLayout_23.setObjectName(u"gridLayout_23")
        self.ldos_delta = LineEdit(self.tab_13)
        self.ldos_delta.setObjectName(u"ldos_delta")

        self.gridLayout_23.addWidget(self.ldos_delta, 2, 1, 1, 1)

        self.label_38 = BodyLabel(self.tab_13)
        self.label_38.setObjectName(u"label_38")

        self.gridLayout_23.addWidget(self.label_38, 2, 0, 1, 1)

        self.label_45 = BodyLabel(self.tab_13)
        self.label_45.setObjectName(u"label_45")

        self.gridLayout_23.addWidget(self.label_45, 0, 0, 1, 1)

        self.ldos_nk = LineEdit(self.tab_13)
        self.ldos_nk.setObjectName(u"ldos_nk")

        self.gridLayout_23.addWidget(self.ldos_nk, 1, 1, 1, 1)

        self.show_ldos = PushButton(self.tab_13)
        self.show_ldos.setObjectName(u"show_ldos")

        self.gridLayout_23.addWidget(self.show_ldos, 4, 0, 1, 2)

        self.ldos_ewindow = LineEdit(self.tab_13)
        self.ldos_ewindow.setObjectName(u"ldos_ewindow")

        self.gridLayout_23.addWidget(self.ldos_ewindow, 0, 1, 1, 1)

        self.label_46 = BodyLabel(self.tab_13)
        self.label_46.setObjectName(u"label_46")

        self.gridLayout_23.addWidget(self.label_46, 1, 0, 1, 1)

        self.ldos_operator = ComboBox(self.tab_13)
        self.ldos_operator.addItem("")
        self.ldos_operator.addItem("")
        self.ldos_operator.setObjectName(u"ldos_operator")

        self.gridLayout_23.addWidget(self.ldos_operator, 3, 1, 1, 1)

        self.label_18 = BodyLabel(self.tab_13)
        ...
        self.label_v1 = BodyLabel(self.tab_12)
        self.label_v1.setObjectName(u"label_v1")

        self.gridLayout_10.addWidget(self.label_v1, 3, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_v2, 4, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_j1, 5, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_j2, 6, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_j3, 7, 0, 1, 1)
        ...
        self.magnetization_nrep = LineEdit(self.tab_8)
        self.magnetization_nrep.setObjectName(u"magnetization_nrep")

        self.gridLayout_17.addWidget(self.magnetization_nrep, 1, 1, 1, 1)

        self.show_magnetism = PushButton(self.tab_8)
        self.show_magnetism.setObjectName(u"show_magnetism")

        self.gridLayout_17.addWidget(self.show_magnetism, 0, 0, 1, 2)

        self.label_39 = BodyLabel(self.tab_8)
        self.label_39.setObjectName(u"label_39")

        self.gridLayout_17.addWidget(self.label_39, 1, 0, 1, 1)

        self.magnetization_plot_mode = ComboBox(self.tab_8)
        self.magnetization_plot_mode.addItem("")
        self.magnetization_plot_mode.addItem("")
        self.magnetization_plot_mode.setObjectName(u"magnetization_plot_mode")

        self.gridLayout_17.addWidget(self.magnetization_plot_mode, 2, 1, 1, 1)

        self.label_49 = BodyLabel(self.tab_8)
        ...
        self.gridLayout_24 = QGridLayout(self.tab_14)
        ...
        self.label_5 = BodyLabel(self.tab_14)
        self.label_5.setObjectName(u"label_5")

        self.gridLayout_15.addWidget(self.label_5, 0, 0, 1, 1)

        self.sdos_ewindow = LineEdit(self.tab_14)
        self.sdos_ewindow.setObjectName(u"sdos_ewindow")

        self.gridLayout_15.addWidget(self.sdos_ewindow, 0, 1, 1, 1)

        self.sdos_delta = LineEdit(self.tab_14)
        self.sdos_delta.setObjectName(u"sdos_delta")

        self.gridLayout_15.addWidget(self.sdos_delta, 1, 1, 1, 1)

        self.show_edge_dos = PushButton(self.tab_14)
        self.show_edge_dos.setObjectName(u"show_edge_dos")

        self.gridLayout_15.addWidget(self.show_edge_dos, 2, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.save_results, 2, 0, 1, 2)

        self.load_results = PushButton(self.centralwidget)
        self.load_results.setObjectName(u"load_results")

        self.gridLayout_7.addWidget(self.load_results, 3, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"1D systems", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"pwave pairing", None))
        self.label_37.setText(QCoreApplication.translate("MainWindow", u"Anti Kane-Mele", None))
        self.label_25.setText(QCoreApplication.translate("MainWindow", u"Anti-Haldane", None))
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"Hoppings", None))
        ...
        self.lattice.setItemText(3, QCoreApplication.translate("MainWindow", u"Chain", None))
        self.lattice.setItemText(4, QCoreApplication.translate("MainWindow", u"Bichain", None))
        ...
        self.bands_color.setItemText(7, QCoreApplication.translate("MainWindow", u"Bulk", None))
        self.bands_color.setItemText(8, QCoreApplication.translate("MainWindow", u"Edge", None))
        ...
        self.label_48.setText(QCoreApplication.translate("MainWindow", u"Operator", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_40.setText(QCoreApplication.translate("MainWindow", u"Number of k-points", None))
        ...
        self.label_36.setText(QCoreApplication.translate("MainWindow", u"Smearing", None))
...
#endif // QT_CONFIG(tooltip)
        self.multildos_nk.setText(QCoreApplication.translate("MainWindow", u"50", None))
        self.show_multildos.setText(QCoreApplication.translate("MainWindow", u"Show LDOS", None))
        self.label_43.setText(QCoreApplication.translate("MainWindow", u"Number of kpoints", None))
        self.label_44.setText(QCoreApplication.translate("MainWindow", u"Number of unit cells", None))
#if QT_CONFIG(tooltip)
        self.multildos_nrep.setToolTip(QCoreApplication.translate("MainWindow", u"Number of replicas of the unit cell to plot", None))
#endif // QT_CONFIG(tooltip)
        self.multildos_nrep.setText(QCoreApplication.translate("MainWindow", u"15", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Basis", None))
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"Local orbital radii", None))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_7), QCoreApplication.translate("MainWindow", u"LDOS", None))
#if QT_CONFIG(tooltip)
        self.ldos_delta.setToolTip(QCoreApplication.translate("MainWindow", u"Energy smearing", None))
#endif // QT_CONFIG(tooltip)
        self.ldos_delta.setText(QCoreApplication.translate("MainWindow", u"0.03", None))
        self.label_38.setText(QCoreApplication.translate("MainWindow", u"Smearing", None))
        self.label_45.setText(QCoreApplication.translate("MainWindow", u"Energy window", None))
#if QT_CONFIG(tooltip)
        self.ldos_nk.setToolTip(QCoreApplication.translate("MainWindow", u"Number of kpoints used", None))
#endif // QT_CONFIG(tooltip)
        self.ldos_nk.setText(QCoreApplication.translate("MainWindow", u"50", None))
        self.show_ldos.setText(QCoreApplication.translate("MainWindow", u"Show LDOS", None))
#if QT_CONFIG(tooltip)
        self.ldos_ewindow.setToolTip(QCoreApplication.translate("MainWindow", u"Energy window", None))
#endif // QT_CONFIG(tooltip)
        self.ldos_ewindow.setText(QCoreApplication.translate("MainWindow", u"1.5", None))
        self.label_46.setText(QCoreApplication.translate("MainWindow", u"Number of kpoints", None))
        self.ldos_operator.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        self.ldos_operator.setItemText(1, QCoreApplication.translate("MainWindow", u"current", None))

        self.label_18.setText(QCoreApplication.translate("MainWindow", u"Operator", None))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_13), QCoreApplication.translate("MainWindow", u"E-y map", None))
        ...
        self.label_33.setText(QCoreApplication.translate("MainWindow", u"# of kpoints", None))
        ...
        self.magnetization_nrep.setText(QCoreApplication.translate("MainWindow", u"5", None))
        self.show_magnetism.setText(QCoreApplication.translate("MainWindow", u"Show magnetism", None))
        self.label_39.setText(QCoreApplication.translate("MainWindow", u"Number of unit cells", None))
        ...
        self.label_49.setText(QCoreApplication.translate("MainWindow", u"Plotting mode", None))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_8), QCoreApplication.translate("MainWindow", u"Magnetism", None))
        self.label_47.setText(QCoreApplication.translate("MainWindow", u"Smearing", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Energy window", None))
        self.sdos_ewindow.setText(QCoreApplication.translate("MainWindow", u"1.0", None))
        self.sdos_delta.setText(QCoreApplication.translate("MainWindow", u"0.01", None))
        self.show_edge_dos.setText(QCoreApplication.translate("MainWindow", u"Compute edge DOS", None))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_14), QCoreApplication.translate("MainWindow", u"Edeg DOS", None))
