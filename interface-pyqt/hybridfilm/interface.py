...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_11 = BodyLabel(self.tab_8)
        ...
        self.label_25 = BodyLabel(self.tab_8)
        ...
        self.label = BodyLabel(self.tab_8)
