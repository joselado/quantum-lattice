...
def initialize():
  ...
  h = g.get_hamiltonian(has_spin=has_spin,tij=specialhopping.multilayer(ti=ti))
...
def show_structure():
  ...
  common.show_structure(qtwrap,get_geometry,script="ql-structure --color True --colorcol 2")
