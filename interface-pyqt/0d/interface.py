...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pwave, 14, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.antihaldane, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.mAF, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.haldane, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.By, 5, 2, 1, 1)
        self.mAB = QtWidgets.QLineEdit(self.tab_3)
        self.mAB.setObjectName("mAB")
        self.gridLayout.addWidget(self.mAB, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.kanemele, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Bz, 6, 2, 1, 1)
        self.Bx = QtWidgets.QLineEdit(self.tab_3)
        self.Bx.setObjectName("Bx")
        self.gridLayout.addWidget(self.Bx, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.rashba, 7, 2, 1, 1)
        self.swave = QtWidgets.QLineEdit(self.tab_3)
        self.swave.setObjectName("swave")
        self.gridLayout.addWidget(self.swave, 13, 2, 1, 1)
        ...
        self.cf_image = QtWidgets.QLabel(self.tab_3)
        self.cf_image.setText("")
        self.cf_image.setObjectName("cf_image")
        self.gridLayout.addWidget(self.cf_image, 2, 1, 1, 1)
        self.bfield_image = QtWidgets.QLabel(self.tab_3)
        self.bfield_image.setText("")
        self.bfield_image.setObjectName("bfield_image")
        ...
        self.gridLayout.addWidget(self.antihaldane_image, 10, 1, 1, 1)
        ...
        self.strain_strength = QtWidgets.QLineEdit(self.tab_14)
        self.strain_strength.setObjectName("strain_strength")
        ...
        self.strain_decay = QtWidgets.QLineEdit(self.tab_14)
        self.strain_decay.setObjectName("strain_decay")
        self.gridLayout_27.addWidget(self.strain_decay, 1, 1, 1, 1)
        self.show_hoppings = QtWidgets.QPushButton(self.tab_14)
        self.show_hoppings.setObjectName("show_hoppings")
        self.gridLayout_27.addWidget(self.show_hoppings, 3, 0, 1, 2)
        self.strain_type = QtWidgets.QComboBox(self.tab_14)
        self.strain_type.setObjectName("strain_type")
        ...
        self.magnetization_plot_mode = QtWidgets.QComboBox(self.tab_6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_37.setText(_translate("MainWindow", "pwave superconductivity"))
        self.label_38.setText(_translate("MainWindow", "Hoppings"))
        ...
        self.label_26.setText(_translate("MainWindow", "swave superconductivity"))
        ...
        self.label_35.setText(_translate("MainWindow", "Non-uniform strain"))
        self.strain_strength.setText(_translate("MainWindow", "0.0"))
        self.label_36.setText(_translate("MainWindow", "Strength"))
        self.label_39.setText(_translate("MainWindow", "Decay length"))
        self.strain_decay.setText(_translate("MainWindow", "3.0"))
        self.show_hoppings.setText(_translate("MainWindow", "Show hoppings"))
        self.strain_type.setItemText(0, _translate("MainWindow", "Radial scalar"))
        self.strain_type.setItemText(1, _translate("MainWindow", "Radial vector"))
        self.label_42.setText(_translate("MainWindow", "Strain type"))
        ...
        self.show_bands.setText(_translate("MainWindow", "Eigenvalues"))
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_5), _translate("MainWindow", "Eigenvalues"))
        ...
        self.label_43.setText(_translate("MainWindow", "Plotting mode"))
